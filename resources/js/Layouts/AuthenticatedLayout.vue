                        ...
                        <div class="flex">
                            ...
                            <div class="flex shrink-0 items-center">
                                <Link :href="route('dashboard')" class="flex items-center gap-2.5">
                                    <ApplicationLogo class="block h-9 w-9 flex-shrink-0" />
                                    <span class="hidden sm:block text-lg font-extrabold tracking-tight text-gray-800 leading-none">
                                        Habit<span class="text-green-600">Track</span>
                                    </span>
                                </Link>
                            </div>
                        ...
                        <div class="hidden sm:ms-6 sm:flex sm:items-center gap-2">
                            ...
                            >
                                ...
                                <span
                                    ...
                                    class="absolute top-1 right-1 inline-flex items-center justify-center h-4 w-4 rounded-full bg-red-500 text-white text-xs font-bold leading-none"
                                >
